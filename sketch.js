...
function draw() {
  ...
  detectCollison(stone,m1);
  detectCollison(stone,m2);
  detectCollison(stone,m3);
  detectCollison(stone,m4);
  detectCollison(stone,m5);
  detectCollison(stone,m6);
  detectCollison(stone,m7);
  detectCollison(stone,m8);
  detectCollison(stone,m9);
  detectCollison(stone,m10);
